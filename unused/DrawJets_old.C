...
TString mainDir = "../../jets/data/jetfinderQA/AnalysisResults/LHC22_apass4/LHC22f_apass4/";
// TString mainDir = "../../jets/data/jetfinderQA/AnalysisResults/LHC22_apass4/";
const char* DatasetName = "LHC22f";
...
void DrawJets() {
    std::vector<TString> fileNames = {"AnalysisResults_520294.root", "AnalysisResults_520259.root", "AnalysisResults_520471.root", "AnalysisResults_520472.root", "AnalysisResults_520473.root", "../../../../../mc/jetfinderQA/AnalysisResults/LHC23d1k/AnalysisResults_520294.root", "../../../../../mc/jetfinderQA/AnalysisResults/LHC23d1k/AnalysisResults_520259.root", "../../../../../mc/jetfinderQA/AnalysisResults/LHC23d1k/AnalysisResults_520471.root", "../../../../../mc/jetfinderQA/AnalysisResults/LHC23d1k/AnalysisResults_520472.root", "../../../../../mc/jetfinderQA/AnalysisResults/LHC23d1k/AnalysisResults_520473.root"};
    std::vector<TString> histNames = {"LHC22f_520294", "520259","520471", "520472", "520473", "LHC23d1k_520294 (MC)", "520259 (MC)","520471 (MC)", "520472 (MC)", "520473 (MC)"};
...
void DrawHistos(const std::vector<TString>& fileNames, const std::vector<TString>& histNames, const std::vector<int>& ColorPallete) {
    ...
    if (ConstituentProperties==1) {
        ...
        constphipad->cd();
        TH1* ConstPhiRatio = DrawConstituentPhi(refPath.Data(), refName, Nevents(refPath.Data(),JEventDir,JEventObj), legconstphi, kBlack);
        for (size_t i = 0; i < std::min(fileNames.size(), histNames.size()); ++i) {
            constphipad->cd(); 
            TString filePath = mainDir + fileNames[i];
    ...
    if(JetProperties==1) {
        ...
        jetphipad->cd();
        TH1* JetPhiRatio = DrawJetPhi(refPath.Data(), refName, Nevents(refPath.Data(),JEventDir,JEventObj), legjetphi, kBlack);
        for (size_t i = 0; i < std::min(fileNames.size(), histNames.size()); ++i) {
            jetphipad->cd(); 
            TString filePath = mainDir + fileNames[i];
